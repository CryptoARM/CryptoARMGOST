...
export const UNZIPPING = "UNZIPPING";
export const MULTI_REVERSE = "MULTI_REVERSE";
...
export const CHANGE_SIGNATURE_TIME = "CHANGE_SIGNATURE_TIME";
...
export const PACKAGE_SELECT_DOCUMENT = "PACKAGE_SELECT_DOCUMENT";
export const MULTI_DIRECT_OPERATION = "MULTI_DIRECT_OPERATION";
export const MULTI_REVERSE_OPERATION = "MULTI_REVERSE_OPERATION";

export const SELECT_DOCUMENT_IN_OPERAIONS_RESULT = "SELECT_DOCUMENT_IN_OPERAIONS_RESULT";
export const UNSELECT_DOCUMENT_IN_OPERAIONS_RESULT = "UNSELECT_DOCUMENT_IN_OPERAIONS_RESULT";
export const UNSELECT_ALL_DOCUMENTS_IN_OPERAIONS_RESULT = "UNSELECT_ALL_DOCUMENTS_IN_OPERAIONS_RESULT";
export const SELECT_ALL_DOCUMENTS_IN_OPERAIONS_RESULT = "SELECT_ALL_DOCUMENTS_IN_OPERAIONS_RESULT";
export const SELECT_SIGNED_DOCUMENTS_IN_OPERAIONS_RESULT = "SELECT_SIGNED_DOCUMENTS_IN_OPERAIONS_RESULT";
export const SELECT_ENCRYPTED_DOCUMENTS_IN_OPERAIONS_RESULT = "SELECT_ENCRYPTED_DOCUMENTS_IN_OPERAIONS_RESULT";
export const SELECT_ARCHIVED_DOCUMENTS_IN_OPERAIONS_RESULT = "SELECT_ARCHIVED_DOCUMENTS_IN_OPERAIONS_RESULT";
...
export const CHANGE_ECRYPT_ALGORITHM = "CHANGE_ECRYPT_ALGORITHM";
...
export const RESET_SETTING_CHANGES = "RESET_SETTING_CHANGES";
export const CHANGE_DEFAULT_SETTINGS = "CHANGE_DEFAULT_SETTINGS";
export const TOGGLE_VERIFY_CERTIFICATE = "TOGGLE_VERIFY_CERTIFICATE";

export const TOGGLE_REVERSE_OPERATIONS = "TOGGLE_REVERSE_OPERATIONS";
export const TOGGLE_ARCHIVATION_OPERATION = "TOGGLE_ARCHIVATION_OPERATION";
export const TOGGLE_ENCRYPTION_OPERATION = "TOGGLE_ENCRYPTION_OPERATION";
export const TOGGLE_SAVE_COPY_TO_DOCUMENTS = "TOGGLE_SAVE_COPY_TO_DOCUMENTS";
export const TOGGLE_SAVE_RESULT_TO_FOLDER = "TOGGLE_SAVE_RESULT_TO_FOLDER";
export const TOGGLE_SIGNING_OPERATION = "TOGGLE_SIGNING_OPERATION";

export const SIGNING_OPERATION = "signing_operation";
export const ARCHIVATION_OPERATION = "archivation_operation";
export const ENCRYPTION_OPERATION = "encryption_operation";

export const CHANGE_TSP_PROXY_LOGIN = "CHANGE_TSP_PROXY_LOGIN";
export const CHANGE_TSP_PROXY_PASSWORD = "CHANGE_TSP_PROXY_PASSWORD";
...
export const CHANGE_OCSP_PROXY_LOGIN = "CHANGE_OCSP_PROXY_LOGIN";
export const CHANGE_OCSP_PROXY_PASSWORD = "CHANGE_OCSP_PROXY_PASSWORD";
...
export const UNSELECT_ALL_FILES = "UNSELECT_ALL_FILES";
...
export const PART_SUCCESS = "_PART_SUCCESS";
...
export const DEFAULT_TEMP_PATH = window.DEFAULT_TEMP_PATH;
...
export const MODAL_BEST_STORE = "MODAL_BEST_STORE";
...
export const SET_SERVICE_AS_DEFAULT = "SET_SERVICE_AS_DEFAULT";

export const CRYPTOPRO_DSS_NAME = "КриптоПро DSS";

export const CA_SERVICE = "CA_SERVICE";
export const CA_SERVICE_LOCAL = "CA_SERVICE_LOCAL";
...
export const SHOW_MODAL_HTTP_ERROR = "SHOW_MODAL_HTTP_ERROR";
export const HIDE_MODAL_HTTP_ERROR = "HIDE_MODAL_HTTP_ERROR";
export const SHOW_DIAGNOSTIC_MODAL_NO_CERT = "SHOW_DIAGNOSTIC_MODAL_NO_CERT";
export const HIDE_DIAGNOSTIC_MODAL_NO_CERT = "HIDE_DIAGNOSTIC_MODAL_NO_CERT";
export const DELETE_TRUSTED_SERVICE = "DELETE_TRUSTED_SERVICE";
export const VERIFY_CERTIFICATE_FOR_TRUSTED_SERVICE = "VERIFY_CERTIFICATE_FOR_TRUSTED_SERVICE";
...
export const GLOBAL_LOCKS_NAVIGATION_LOCK = "GLOBAL_LOCKS_NAVIGATION_LOCK";
export const GLOBAL_LOCKS_NAVIGATION_UNLOCK = "GLOBAL_LOCKS_NAVIGATION_UNLOCK";

export const URL_CMD = "URL_CMD";
...
export const URL_CMD_CERT_INFO = "URL_CMD_CERT_INFO";
...
export const SERVICE_CHAIN = `-----BEGIN CERTIFICATE-----
