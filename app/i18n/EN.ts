...
export default {
  ...
  DiagnosticInfo: {
    information_about_system: "Information about system",
    arch: "architecture - ",
    type: "type - ",
    platform: "platform - ",
    OC_type: "OC type - ",
    crypto_pro_provider: "CryptoProvider CryptoPro CSP:",
    install: "installed",
    not_install: "not installed",
    improved_sign: "Module \"Improved sign\":",
    versions: "Versions:",
    crypto_arm: "CryproARM - ",
    crypro_pro: "CryptoPro CSP - ",
    providers: "CryptoProviders:",
    provider_256: "CryptoProvider GOST 2012-256 - ",
    provider_512: "CryptoProvider GOST 2012-512 - ",
    license: "Licenses:",
    lic_temporary: "temporary",
    lic_permament: "permament",
    lic_none: "none",
    lic_crypto_arm: "CryproARM license status - ",
    lic_crypto_pro: "CryptoPro CSP license status - ",
    valid: "valid",
    invalid: "invalid",
  ...
  Documents: {
    ...
    selected_archived: "Select arcives",
    selected_encrypted: "Select encrypted",
    selected_signed: "Select signed",
  ...
  NamePropertie: {
    "1.2.643.2.2.44.5": "DNS Full Name List",
    "C": "C",
    "CN": "CN",
    "E": "Email",
    "G": "GivenName",
  ...
  OIDs: {
    ...
    "1.2.643.2.2.3": "GOST R 34.11/34.10-2001",
    "1.2.643.2.2.4": "GOST R 34.11/34.10-94",
    ...
    "1.2.643.7.1.1.2.3": "GOST R 34.11-2012 512 bit",
  ...
  Problems: {
    ...
    problem_9: "One or more of the selected certificates is invalid. Continue the operation?",
    problem_9_1: "Selected certificate is invalid. Continue the operation?",
    resolve_1_1: "There is no installed crypto provider SKZI \"CryptoPro CSP\".",
    resolve_1_2: "To install CryptoPro CSP, go to ",
    resolve_1_3: " and follow the suggested steps in the master.",
    resolve_1_4: "Links to instructions for installing CryptoPro CSP on supported OS: ",
    ...
    resolve_5_1: "The app is missing the personal certificates required to complete the signing or decryption operation.",
    resolve_5_2: "There are several ways to install a certificate:",
    resolve_5_3: "if the certificate is on a key medium (USB token or smart card), then you need to insert the medium into the computer, click the Install button, select the import method from the USB token / smart card;",
  ...
  Sign: {
    ...
    documents_reviewed: "Documents were reviewed",
  ...
  TrustedServices: {
    ...
    cert_params: "Service certificate:",
    cert_subj: "Subject",
  ...
  UrlCommand: {
    ...
    cert_info_fail: "Operation \"Certificate info\" interrupted",
    cert_info_success: "Operation \"Certificate info\" completed successfully",
    certificate_info_header: "Certificate",
    certificate_load_error: "Certificate load error",
    certs_export_fail: "Certificates export failed",
    certs_export_success: "Certificates successfully exported",
    server_error_method_not_allowed: "Request error: Method not supported",
    server_error_unsupported_media: "Request error: Unsupported Media Type",
  },
};
