...
export default {
  About: {
    ...
    Info: "Information",
    about: "About the program",
    about_programm: "Application CryptoARM for ViPNet is designed to create electronic signature and file encryption using digital certificates and cryptographic algorithms",
    ...
    info_about_product: "CryptoARM for ViPNet is a desktop app that allows you to sign documents and encrypt files using digital certificates and cryptographic algorithms.",
    ...
    product_NAME: "CryptoARM for ViPNet",
    product_name: "CryptoARM for ViPNet",
    send: "Send",
    support: "Support",
    username: "Name",
  ...
  Cades: {
    port: "Port",
    service_ocsp: "Online certificate status service (OCSP)",
    service_tsp: "Timestamp service (TSP)",
    set_timestamp_on_data: "Set time-stamp on signed data",
    set_timestamp_on_sign: "Set time-stamp on signature",
    timestamp_on_cades: "CAdES-C time-stamp",
    timestamp_on_data: "Time-stamp on signed data",
    timestamp_on_sign: "Time-stamp on signature",
  ...
  Certificate: {
    ...
    delete_certificate_and_container: "Delete certificate by container",
    ...
    sidesubmenu_crls: "Revocation list",
    sidesubmenu_intermediate: "Intermediate",
    sidesubmenu_keys: "Keys",
    sidesubmenu_my: "Personal",
    sidesubmenu_other: "Other user",
    sidesubmenu_request: "Enrollment request",
    sidesubmenu_root: "Trusted root",
    sidesubmenu_token: "External tokens",
  ...
  Csp: {
    ...
    libcapi: "Cannot find libcapi. Install ViPNet CSP",
  ...
  DSS: {
    ...
    authorization_successful: "User authorization successful",
    ...
    enter_your_pin: "Enter your pin code for container",
    get_certificates_failed: "Error get cloud certificates (DSS)",
    get_certificates_successful: "Successful get cloud certificates",
    has_pin: "A PIN is assigned to the private key of the certificate. To continue the operation, enter it",
    login_dss: "Login",
  ...
  License: {
    ...
    enter_key_ocsp: "Enter the license CryptoPro OCSP Client",
    enter_key_tsp: "Enter the license CryptoPro TSP Client",
    ...
    overtimes_license_confirm: "To send a request for a temporary license for the CryptoARM for ViPNet product, for a period of 14 days, fill out the form floor. A temporary license is issued once per workplace to familiarize yourself with all the features of the software product.",
    overtimes_license_error: "The request for obtaining a temporary license for the CryptoARM for ViPNet product was rejected. Perhaps, for the email address you have already issued a license. To resolve this issue, please contact technical support at info@trusted.ru.",
    overtimes_license_ok: "A temporary license for the use of the CryptoARM for ViPNet product was obtained. You can install it on the workstation. After installing the license, you must restart the application.",
  ...
  Problems: {
    problem_1: "There is no crypto provider ViPNet CSP",
    problem_2: "There is no license for crypto provider CryptoPro CSP",
    problem_3: "There is no license for CryptoARM for ViPNet",
    problem_4: "Could not check the parameters of crypto provider ViPNet CSP",
    ...
    resolve_1_1: "The system does not have the ViPNet CSP crypto provider installed. The further operation of the application is impossible and the application will be closed.",
    resolve_1_2: "To solve this problem, install ViPNet CSP and run the application again.",
    resolve_1_3: "Distribution of the crypto provider ViPNet CSP can be downloaded from the official Infotecs website",
    ...
    resolve_4_1: "When the application started, there were problems with reading the parameters of the detected ViPNet CSP. The further operation of the application is impossible and the application will be closed.",
    resolve_4_2: "To solve this problem, you need to install the required version of the ViPNet CSP crypto provider and start the application again.",
  ...
  Settings: {
    ...
    name: "Name",
    need_save_settings: "To select options, save the current changes",
