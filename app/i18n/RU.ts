...
export default {
  ...
  Cades: {
    ...
    set_timestamp_on_data: "Добавлять штамп времени на подписываемые данные",
    set_timestamp_on_sign: "Добавлять штамп времени на подпись",
    ...
    use_proxy: "Использовать натройки прокси-сервера",
  },
  Certificate: {
