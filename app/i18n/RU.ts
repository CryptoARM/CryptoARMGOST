...
export default {
  ...
  Certificate: {
    ...
    cert_add_is_GOST: "Ошибка. Одновременно можно выбрать сертификаты шифрования только ГОСТ",
    cert_add_is_RSA: "Ошибка. Одновременно можно выбрать сертификаты шифрования только RSA",
