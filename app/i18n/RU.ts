...
export default {
  ...
  Problems: {
    ...
    resolve_1_3: "Для установки СКЗИ КриптоПро CSP перейдите по ссылке: ",
    ...
    resolve_5_7: "Другие способы установки личных сертификатов описаны в документации по продукту, которая доступна по ссылке ",
    ...
    resolve_table_4: "Создать самоподписанный сертификат для тестовых целей",
    resolve_table_5: "Приобрести сертификат",
  },
  Request: {
