...
export default {
  About: {
    ...
    address: "424000, РМЭ, г. Йошкар-Ола, ул. Карла Маркса, д. 109Б, позиция 48",
    ...
    version_full: "Версия продукта: 2.5.12",
  },
  AddressBook: {
  ...
  CSR: {
    ...
    template_client_auth: "Аутентификация клиента",
    template_kep_fiz: "Сертификат КЭП физического лица",
    template_kep_ip: "Сертификат КЭП индивидуального предпринимателя",
    template_kep_yur: "Сертификат КЭП юридического лица",
    template_label: "Шаблон сертификата",
    title: "Должность",
  },
  Cades: {
    port: "Порт",
    service_ocsp: "Служба онлайн статусов (OCSP)",
    service_tsp: "Служба штампов времени (TSP)",
    set_timestamp_on_data: "Штамп времени на подписываемые данные",
    set_timestamp_on_sign: "Штамп времени на подпись",
    timestamp_on_cades: "Штамп времени на доказательства",
    timestamp_on_data: "Штамп времени на данные",
    timestamp_on_sign: "Штамп времени на подпись",
    timestamp_type: "Тип штампа времени",
    url_ocsp: "Адрес службы онлайн статусов",
    url_proxy: "Адрес прокси сервера",
    url_tsp: "Адрес службы штампов времени",
    use_proxy: "Использовать настройки прокси-сервера",
  },
  Certificate: {
    ...
    cert_import_auto: "Поместить сертификат в хранилище, выбранное автоматически",
    cert_import_current: "Поместить сертификат в текущее хранилище",
    ...
    certs_root: "Доверенные корневые УЦ",
    ...
    sidesubmenu_crls: "Списки отзыва",
    sidesubmenu_intermediate: "Промежуточные",
    sidesubmenu_keys: "Ключи",
    sidesubmenu_my: "Личные",
    sidesubmenu_other: "Других пользователей",
    sidesubmenu_request: "Запросы",
    sidesubmenu_root: "Доверенные корневые",
    sidesubmenu_token: "Внешних носителей",
  ...
  DSS: {
    ...
    authorization_failed: "Ошибка авторизации пользователя",
    ...
    enter_your_pin: "Введите свой пин-код от контейнера",
    get_certificates_failed: "Ошибка при получениие облачных сертификатов (DSS)",
    get_certificates_successful: "Облачные сертификаты получены",
    has_pin: "На закрытый ключ сертификата задан ПИН-код. Введите его, для продолжения операции",
    login_dss: "Логин",
    ...
    pin_dss: "ПИН-код",
    remember_password: "Запомнить пароль (до выхода из приложения)",
  ...
  DiagnosticInfo: {
    ...
    platform: "платформа - ",
    OC_type: "тип ОС - ",
    crypto_pro_provider: "Криптопровайдер КриптоПро CSP:",
    install: "установлен",
    not_install: "не установлен",
    improved_sign: "Модуль \"Усовершенственная подпись\":",
    versions: "Версии:",
    crypto_arm: "КриптоАРМ - ",
    crypro_pro: "КриптоПро CSP - ",
    providers: "Провайдеры:",
    provider_256: "Криптопровайдер ГОСТ 2012-256 - ",
    provider_512: "Криптопровайдер ГОСТ 2012-512 - ",
    license: "Лицензии:",
    lic_temporary: "временная",
    lic_permament: "бессрочная",
    lic_none: "отсутствует",
    lic_crypto_arm: "Статус лизензии КриптоАРМ - ",
    lic_crypto_pro: "Статус лизензии КриптоПро CSP - ",
    valid: "действительна",
    invalid: "недействительна",
    copy_text: "Информация о системе скопирована в буфер обмена.",
    copy: "Копировать",
    documentation_text: "документации КриптоАРМ ГОСТ",
  },
  Documents: {
    Documents: "ДОКУМЕНТЫ",
    ...
    archived_files: "Заархивированные файлы",
    filename: "Имя файла",
    filesize: "Размер",
    ...
    selected_archived: "Выделить архивы",
    selected_encrypted: "Выделить зашифрованные",
    selected_signed: "Выделить подписанные",
  ...
  License: {
    ...
    buy_license: "Купить лицензию",
    enter_key: "Ввод лицензии",
    enter_key_csp: "Ввод лицензии КриптоПро CSP",
    enter_key_ocsp: "Ввод лицензии КриптоПро OCSP Client",
    enter_key_tsp: "Ввод лицензии КриптоПро TSP Client",
    ...
    get_overtimes_license: "Получение временной лицензии",
    ...
    link_buy_license_ocsp: "https://cryptoarm.ru/shop/cryptopro-ocsp-client",
    link_buy_license_tsp: "https://cryptoarm.ru/shop/cryptopro-tsp-client",
  ...
  NamePropertie: {
    ...
    "OGRN": "ОГРН",
    "OGRNIP": "ОГРНИП",
    "1.2.643.2.2.44.5": "Список полных имен DNS",
  ...
  OIDs: {
    ...
    "1.2.643.3.131.1.1": "ИНН физического лица",
    ...
    "2.5.4.9": "Адрес",
    "1.2.643.100.4": "ИНН ЮЛ",
    "1.2.643.7.1.1.3.2": "ГОСТ Р 34.11-2012/34.10-2012 256 бит",
    "1.2.643.7.1.1.3.3": "ГОСТ Р 34.11-2012/34.10-2012 512 бит",
    "1.2.643.2.2.3": "ГОСТ Р 34.11/34.10-2001",
    "1.2.643.2.2.4": "ГОСТ Р 34.11/34.10-94",
  ...
  Operations: {
    ...
    failed: "Ошибка",
    files_all: "Всего",
    files_archived: "Заархивированных",
  ...
  Problems: {
    ...
    problem_7: "Не загружен модуль trusted-curl",
    problem_8: "Отсутствуют установленные модули КриптоПро TSP Client 2.0 и/или КриптоПро OCSP Client 2.0",
    problem_9: "Один или несколько выбранных сертификатов недействительны. Продолжить операцию?",
    problem_9_1: "Выбранный сертификат недействителен. Продолжить операцию?",
    resolve_1_1: "Отсутствует установленный криптопровайдер СКЗИ «КриптоПро CSP».",
    resolve_1_2: "Чтобы установить КриптоПро CSP, перейдите по ",
    resolve_1_3: " и следуйте предлагаемым шагам мастера.",
    resolve_1_4: "Ссылки на инструкции по установке КриптоПро CSP на поддерживаемых ОС: ",
    ...
    resolve_5_1: "В приложении отсутствуют личные сертификаты, необходимые для выполнения операции подписи или расшифрования.",
    resolve_5_2: "Установить сертификат можно несколькими способами:",
    resolve_5_3: "если сертификат на ключевом носителе (USB токен или смарт-карта), то нужно вставить носитель в компьютер,  нажать кнопку Установить, выбрать способ импорта с USB токена/смарт-карты;",
    resolve_5_4: "если сертификат и закрытый ключ в файле формата PFX, то нужно нажать кнопку Установить и выбрать способ импорта из файла;",
    resolve_5_5: "если сертификат храниться в DSS, то нужно нажать кнопку Установить и выбрать способ импорта из КриптоПро DSS;",
    resolve_5_6: "также можно создать самоподписанный сертификат для тестовых целей. Для этого нужно нажать кнопку Установить и выбрать создание запроса.",
    resolve_5_7: "Подробнее о способах установки личных сертификатов смотрите в ",
    ...
    resolve_7_1: "При запуске КриптоАРМ ГОСТ не загрузился модуль trusted-curl, необходимый для работы некоторых функций приложения (взаимодействие с КриптоПро DSS и УЦ 2.0)",
    resolve_7_2: "Для решения данной проблемы откройте панель управления приложения и перешлите сообщения об ошибках, выведенных на вкладке Консоль, в службу технической поддержки.",
    resolve_7_3: "Подробные инструкции по открытию панели управления под требуемой платформой можно найти в документации по продукту, которая доступна по ссылке ",
    resolve_8_1: "В системе отсутствуют установленные модули КриптоПро TSP Client 2.0 и КриптоПро OCSP Client 2.0. Опции для создания электронных подписей по стандарту CAdES-X Long Type 1 и для добавления штампов времени на подписи недоступны для выбора",
    resolve_8_2: "После установки модулей КриптоПро TSP Client 2.0 и КриптоПро OCSP Client 2.0 и перезапуска приложения, опции для создания электронных подписей по стандарту CAdES-X Long Type 1 и для добавления штампов времени будут доступны.",
    resolve_8_3: "Установка модулей. Модули КриптоПро TSP Client 2.0 и КриптоПро OCSP Client 2.0 содержатся в составе КриптоПро ЭЦП Browser plug-in 2.0 или КриптоПро ЭЦП SDK 2.0, загрузить которые можно с официального сайта производителя ",
    resolve_table_1: "Импорт с USB токена/смарт-карты",
    resolve_table_2: "Импорт из файла",
    resolve_table_3: "Импорт из КриптоПро DSS",
    resolve_table_4: "Создать самоподписанный сертификат",
    resolve_table_5: "Заказать сертификат в УЦ",
  },
  Request: {
  ...
  Settings: {
    ...
    name: "Наименование",
    need_save_settings: "Для возможности выбора параметров, сохраните текущие изменения",
    ...
    settings_name: "Название параметров",
  ...
  Sign: {
    ...
    documents_reviewed: "Документы просмотрены",
  ...
  TrustedServices: {
    ...
    cert_subj: "Владелец",
    do_not_show_again: "Больше не показывать диалог для этого сервиса",
    error_load_cert: "Не удалось получить сертификат",
    external_resource_request: "Разрешение доступа для внешнего сервиса",
    requests_for_cryptoarm: "запрашивает доступ к КриптоАРМ ГОСТ для обмена данными.",
    site: "Внешний сервис",
  ...
  UrlCommand: {
    ...
    cert_info_fail: "Операция \"Информация о сертификате\" не завершена",
    cert_info_success: "Операция \"Информация о сертификате\" успешно завершена",
    certificate_info_header: "Информация о сертификате",
    ...
    server_error_method_not_allowed: "Ошибка отправки запроса: метод не поддерживается",
    server_error_unsupported_media: "Ошибка отправки запроса: неподдерживаемый тип данных",
  },
};
