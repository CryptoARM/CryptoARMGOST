...
export default {
  About: {
    ...
    Info: "Информация",
    about: "О программе",
    about_programm: "Приложение КриптоАРМ для ViPNet предназначено для создания электронной подписи и шифрования файлов с применением цифровых сертификатов и криптографических алгоритмов",
    ...
    info_about_product: "Приложение КриптоАРМ для ViPNet предназначено для создания электронной подписи и шифрования файлов с применением цифровых сертификатов и криптографических алгоритмов",
    ...
    product_NAME: "КриптоАРМ для ViPNet",
    product_name: "КриптоАРМ для ViPNet",
    send: "Отправить",
    ...
    version_full: "Версия продукта: 1.0.1",
  },
  AddressBook: {
  ...
  Csp: {
    ...
    libcapi: "Не установлен необходимый для работы приложения крипровайдер ViPNet CSP.  ",
  ...
  Help: {
    ...
    link_user_guide_name: " КриптоАРМ для ViPNet Руководство пользователя.pdf",
  ...
  License: {
    About_License: "Сведения о лицензии КриптоАРМ для ViPNet",
    ...
    enter_key_ocsp: "Ввод лицензиии КриптоПро OCSP Client",
    enter_key_tsp: "Ввод лицензиии КриптоПро TSP Client",
    ...
    overtimes_license_confirm: "Для отправки запроса на получение временной лицензии на продукт КриптоАРМ для ViPNet, сроком на 14 дней, заполните полу формы. Временная лицензия выдается один раз на одно рабочее место для знакомства со всеми возможностями программного продукта.",
    overtimes_license_error: "Запрос на получение временной лицензии на продукт КриптоАРМ для ViPNet был отклонен. Возможно, для указанного Вами email адреса уже выдавалась лицензия. Для решения данного вопроса обратитесь в службу технической поддержки info@trusted.ru.",
    overtimes_license_ok: "Временная лицензия на использование продукта КриптоАРМ для ViPNet получена. Вы можете установить ее на рабочее место. После установки лицензии требуется выполнить перезагрузку приложения.",
  ...
  Problems: {
    problem_1: "Отсутствует СКЗИ ViPNet CSP",
    problem_2: "Отсутствует лицензия на СКЗИ КриптоПро CSP",
    problem_3: "Отсутствует лицензия на КриптоАРМ для ViPNet",
    problem_4: "Не удалось проверить параметры СКЗИ ViPNet CSP",
    ...
    resolve_1_1: "В системе отсутствует установленный криптопровайдер ViPNet CSP.",
    resolve_1_2: "Для решения данной проблемы установите СКЗИ ViPNet CSP снова запустите приложение.",
    resolve_1_3: "Дистрибутив СКЗИ ViPNet CSP можно скачать по ссылке c официального сайта компании ИнфоТеКС ",
    ...
    resolve_3_1: "В приложении отсутствует установленная лицензия на программный продукт КриптоАРМ для ViPNet.",
    ...
    resolve_4_2: "Для решения данной проблемы необходимо установить требуемую версию криптопровайдера ViPNet CSP и запустить приложение снова.",
    ...
    resolve_6_1: "При запуске КриптоАРМ для ViPNet не загрузился необходимый для работы приложения модуль Trusted Crypto.",
    ...
    resolve_7_1: "При запуске КриптоАРМ для ViPNet не загрузился модуль trusted-curl, необходимый для работы некоторых функций приложения (взаимодействие с КриптоПро DSS и УЦ 2.0)",
